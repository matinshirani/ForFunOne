...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <a href="/lang/en" style="padding-right: 10px; font-weight: bold;">English</a>
    <a href="/lang/fa" style="font-weight: bold;">فارسی</a>
        <div class="relative sm:flex sm:justify-center sm:items-center min-h-screen bg-dots-darker bg-center bg-gray-100 dark:bg-dots-lighter dark:bg-gray-900 selection:bg-red-500 selection:text-white">
            ...
            <div class="max-w-7xl mx-auto p-6 lg:p-8">
                ...
                <ul>
                    <li><h2><strong><a href="/products">{{__("messages.Products")}}</a></strong></h2></li>
                    <li><h2><strong><a href="/categories">{{__("messages.Categories")}}</a></strong></h2></li>
                </ul>
